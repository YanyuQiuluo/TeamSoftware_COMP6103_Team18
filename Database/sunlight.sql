...
INSERT INTO `country` VALUES (123,'Tanzania',62.41,0.21,500,0),(456,'Kenya',98.84,0.36,600,100),(789,'Ethiopia',107.6,0.15,550,320);
...
CREATE TABLE `transaction` (
  ...
  KEY `fk_transaction_country_idx` (`country_id`) /*!80000 INVISIBLE */,
  KEY `fk_transaction_user1_idx` (`user_id`),
  CONSTRAINT `fk_transaction_country` FOREIGN KEY (`country_id`) REFERENCES `country` (`country_id`),
...
-- Dump completed on 2022-03-25 17:48:34
